...
# Build Amiberry
version=$(curl -sSf 'https://api.github.com/repos/BlitterStudio/amiberry/releases/latest' | mawk -F\" '/^  "tag_name"/{print $4}')
...
# - Copy files in place
G_EXEC_OUTPUT=1 G_EXEC cmake --install "amiberry-$version/build" --prefix "$DIR/usr"
# - Obtain library dir
