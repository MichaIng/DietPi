...
readonly G_PROGRAM_NAME='DietPi-ympd_container_setup'
G_CHECK_ROOT_USER
G_CHECK_ROOTFS_RW
...
#!/bin/dash
echo '[ INFO ] Running ympd build script...'
bash -c "\$(curl -sSf 'https://raw.githubusercontent.com/$G_GITOWNER/DietPi/$G_GITBRANCH/.build/software/ympd/build.bash')"
mv -v '/tmp/ympd_$ARCH.deb' /
poweroff
_EOF_
...
[[ -f rootfs/ympd_$ARCH.deb ]] || exit 1
}
