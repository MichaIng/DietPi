...
aREGEX[$software_id]='fallback_url='\''https://download\.phpbb\.com/pub/release/.*/.*/phpBB-.*\.tar\.bz2'\'''
aREPLACE[$software_id]='fallback_url='\''https://download\.phpbb\.com/pub/release/${release%.*}/$release/phpBB-$release\.tar\.bz2'\'''
