...
_EOF_
		...
		if (( $G_HW_ARCH == 10 )); then
			...
			then
				G_EXEC_DESC='Installing GRUB for UEFI' G_EXEC_OUTPUT=1 G_EXEC grub-install --target=x86_64-efi --efi-directory=/boot/efi --bootloader-id=arch_grub --uefi-secure-boot --recheck
